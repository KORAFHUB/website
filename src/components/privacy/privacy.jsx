    ...
    <div className={`bg-primary ${styles.paddingX} ${styles.flexCenter}`}>
      <div className={`${styles.boxWidth}`}>
        ...
        <ul>
          ...
          <li>
            <p ><strong>Website</strong> refers to korafhub, accessible from <a href="www.korafhub.com" rel="external nofollow noopener" target="_blank" className="text-white">www.korafhub.com</a></p>
          </li>
